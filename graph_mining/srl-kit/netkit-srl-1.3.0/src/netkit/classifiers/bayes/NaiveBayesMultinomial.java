/**
 * NaiveBayesMultinomial.java from Weka --- not redistrubtable with NetKit
 */
...
package netkit.classifiers.bayes;
      ...
      if(inst.index(i) != inst.classIndex())
	{
	  ...
	  answer += (freqOfWordInDoc * probOfWordGivenClass[classIndex][inst.index(i)] 
          ...
          if(Double.isNaN(answer))
              System.err.println("ERROR: answer is NaN!? freqOfWordInDoc["+i+"]="+freqOfWordInDoc+" probOfWordGivenClass["+classIndex+"]["+i+"]="+probOfWordGivenClass[classIndex][inst.index(i)]);
	}
